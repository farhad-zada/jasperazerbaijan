...
export const pricesData = [
  {
    ...
    goodFor: "Personal websites, small business websites, portfolio websites",
    highlight: false,
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      "3 domains + 10 subdomains",
      "20 email accounts",
      "10 MySQL databases",
      "Free SSL certificate",
      "Daily automatic backups",
      "Enhanced DDoS protection 4TB",
      "CDN integration",
      "24/7 email and phone support",
      "WordPress/CMS acceleration",
      "RESTful API support for mobile applications",
    ],
  },
  {
    id: 3,
    ...
    highlight: false,
    goodFor:
      "Large enterprises, high-traffic websites, blockchain projects, complex web applications",
    features: [
      "512 GB SSD disk space",
      ...
      "Premium DDoS protection 4TB",
      "Global CDN network",
      "24/7 priority support and personal server manager",
